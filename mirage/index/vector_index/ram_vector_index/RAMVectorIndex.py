...
class RAMVectorIndex(VectorIndex, ABC):
    ...
    def attach_chunk_storage_key_to_vector(
        self, vector: ndarray, chunk_storage_key: str
    ) -> None:
        raise NotImplementedError
    ...
    def save(self, filename: str) -> None:
        ...
        for vector, chunk_storage_key in self:
            json_to_save.append([vector.tolist(), chunk_storage_key])
    ...
    def load(self, filename: str) -> None:
        ...
        with open(filename, encoding="utf-8") as file:
            json_to_load = json.loads(file.read())
        ...
        for vector, chunk_storage_key in json_to_load:
            self.attach_chunk_storage_key_to_vector(array(vector), chunk_storage_key)
